...
export default function WeatherWidget({ city }: { city: string }) {
  ...
  return (
    <a 
      ...
      className="absolute bottom-2 left-2 bg-white/90 dark:bg-slate-800/90 p-2 rounded-xl shadow-lg backdrop-blur-md z-10 border border-slate-200 dark:border-slate-700 flex flex-col items-center justify-center gap-1 hover:bg-white dark:hover:bg-slate-800 transition-all group hover:scale-105 active:scale-95 w-16 h-16"
    >
